...
class DocumentsIngestNodeConfig(NodeConfig):
    ...
    '''
    def __init__(self, document_name:str, text:str=None, tagged_elements:list=None, meta:dict=None):
...
class DocumentsSearchNodeConfig(NodeConfig):
    ...
    '''
    def __init__(self, query:str=None, filters:dict=None, document_ids:list=None, top_n_keywords:int=5,
...
class DocumentsDeleteNodeConfig(NodeConfig):
    ...
    '''
    def __init__(self, user:str, document_ids:list):
