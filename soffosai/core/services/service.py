...
class SoffosAIService:
    ...
    def __init__(self, service:str, **kwargs) -> None:            
        ...
        self._args_dict = {}
        self.source_config = kwargs.get('source') # in Pipeline 'use_defaults' scenario, source_config will be generated by set_defaults()
    ...
    def input_structure(self):
        '''
        This is the structure of the src dictionary for this service. Take note that some of the fields should not exist at the same time.
    ...
    def output_structure(self):
        '''
        This is the output dictionary structure of this service.
        '''
        return self._serviceio.output_structure
    ...
    def set_pipeline_input(self):
        ...
        '''
        if "name" in self.source_config:
            self.name = self.source_config.pop('name')
