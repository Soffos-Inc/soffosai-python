...
class NamedEntityRecognitionService(SoffosAIService):
    ...
    def set_pipeline_input(self, ref_name:str, text:Union[str, Dict], labels:Union[dict, Dict]=None) -> None:
        self.source_config = inspect_arguments(self.set_pipeline_input, ref_name, text, labels)
