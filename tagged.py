tagged_elements = [
        ...
        {
            "text": "Epidemiology is the study and analysis of the distribution (who, when, and where), patterns and determinants of health and disease conditions in defined populations.",
            "tag": "paragraph",
            "headings": []
        },
        {
        ...
        {
            "text": "See also: History of emerging infectious diseases",
            "tag": "paragraph",
            "headings": []
        },
        {
        ...
        {
            "text": "Original map by John Snow showing the clusters of cholera cases in the London epidemic of 1854.",
            "tag": "paragraph",
            "headings": []
        },
        {
        ...
        {
            "text": "Another breakthrough was the 1954 publication of the results of a British Doctors Study, led by Richard Doll and Austin Bradford Hill, which lent very strong statistical support to the link between tobacco smoking and lung cancer.",
            "tag": "paragraph",
            "headings": []
        },
        {
        ...
        {
            "text": "Since the 2000s, genome-wide association studies (GWAS) have been commonly performed to identify genetic risk factors for many diseases and health conditions.",
            "tag": "paragraph",
            "headings": []
        },
        {
        ...
        {
            "text": "Modern epidemiological studies can use advanced statistics and machine learning to create predictive models as well as to define treatment effects.[40][41]",
            "tag": "paragraph",
            "headings": []
        },
        {
        ...
        {
            "text": "Main article: Study design",
            "tag": "paragraph",
            "headings": []
        },
        {
        ...
        {
            "text": "Observational studies have two components, descriptive and analytical. Descriptive observations pertain to the \"who, what, where and when of health-related state occurrence\". However, analytical observations deal more with the 'how' of a health-related event.[42] Experimental epidemiology contains three case types: randomized controlled trials (often used for new medicine or drug testing), field trials (conducted on those at a high risk of contracting a disease), and community trials (research on social originating diseases).[42]",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "The term 'epidemiologic triad' is used to describe the intersection of Host, Agent, and Environment in analyzing an outbreak.",
            "tag": "paragraph",
            "headings": []
        },
        {
        ...
        {
            "text": "UnexposedCD(C + D)",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "As with the OR, a RR greater than 1 shows association, where the conclusion can be read \"those with the exposure were more likely to develop disease.\"",
            "tag": "paragraph",
            "headings": []
        },
        {
        ...
        {
            "text": "Cohort studies also are limited by the same equation for number of cases as for cohort studies, but, if the base incidence rate in the study population is very low, the number of cases required is reduced by \u00bd.",
            "tag": "paragraph",
            "headings": []
        },
        {
        ...
        {
            "text": "Main article: Causal inference",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Although epidemiology is sometimes viewed as a collection of statistical tools used to elucidate the associations of exposures to health outcomes, a deeper understanding of this science is that of discovering causal relationships.",
            "tag": "paragraph",
            "headings": []
        },
        {
        ...
        {
            "text": "Main article: Bradford Hill criteria",
            "tag": "paragraph",
            "headings": []
        },
        {
        ...
        {
            "text": "Strength of Association: A small association does not mean that there is not a causal effect, though the larger the association, the more likely that it is causal.[46]",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Consistency of Data: Consistent findings observed by different persons in different places with different samples strengthens the likelihood of an effect.[46]",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Specificity: Causation is likely if a very specific population at a specific site and disease with no other likely explanation. The more specific an association between a factor and an effect is, the bigger the probability of a causal relationship.[46]",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Temporality: The effect has to occur after the cause (and if there is an expected delay between the cause and expected effect, then the effect must occur after that delay).[46]",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Biological gradient: Greater exposure should generally lead to greater incidence of the effect. However, in some cases, the mere presence of the factor can trigger the effect. In other cases, an inverse proportion is observed: greater exposure leads to lower incidence.[46]",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Plausibility: A plausible mechanism between cause and effect is helpful (but Hill noted that knowledge of the mechanism is limited by current knowledge).[46]",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Coherence: Coherence between epidemiological and laboratory findings increases the likelihood of an effect. However, Hill noted that \"... lack of such [laboratory] evidence cannot nullify the epidemiological effect on associations\".[46]",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Experiment: \"Occasionally it is possible to appeal to experimental evidence\".[46]",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Analogy: The effect of similar factors may be considered.[46]",
            "tag": "paragraph",
            "headings": []
        },
        {
        ...
        {
            "text": "Epidemiological studies can only go to prove that an agent could have caused, but not that it did cause, an effect in any particular case:",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "\"Epidemiology is concerned with the incidence of disease in populations and does not address the question of the cause of an individual's disease. This question, sometimes referred to as specific causation, is beyond the domain of the science of epidemiology. Epidemiology has its limits at the point where an inference is made that the relationship between an agent and a disease is causal (general causation) and where the magnitude of excess risk attributed to the agent has been determined; that is, epidemiology addresses whether an agent can cause a disease, not whether an agent did cause a specific plaintiff's disease.\"[48]",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "In United States law, epidemiology alone cannot prove that a causal association does not exist in general. Conversely, it can be (and is in some circumstances) taken by US courts, in an individual case, to justify an inference that a causal association does exist, based upon a balance of probability.",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "The subdiscipline of forensic epidemiology is directed at the investigation of specific causation of disease or injury in individuals or groups of individuals in instances in which causation is disputed or is unclear, for presentation in legal settings.",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Population-based health management",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Epidemiological practice and the results of epidemiological analysis make a significant contribution to emerging population-based health management frameworks.",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Population-based health management encompasses the ability to:",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Assess the health states and health needs of a target population;",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Implement and evaluate interventions that are designed to improve the health of that population; and",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Efficiently and effectively provide care for members of that population in a way that is consistent with the community's cultural, policy and health resource values.",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Modern population-based health management is complex, requiring a multiple set of skills (medical, political, technological, mathematical, etc.) of which epidemiological practice and analysis is a core component, that is unified with management science to provide efficient and effective health care and health guidance to a population. This task requires the forward-looking ability of modern risk management approaches that transform health risk factors, incidence, prevalence and mortality statistics (derived from epidemiological analysis) into management metrics that not only guide how a health system responds to current population health issues but also how a health system can be managed to better respond to future potential population health issues.[49]",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Examples of organizations that use population-based health management that leverage the work and results of epidemiological practice include Canadian Strategy for Cancer Control, Health Canada Tobacco Control Programs, Rick Hansen Foundation, Canadian Tobacco Control Research Initiative.[50][51][52]",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Each of these organizations uses a population-based health management framework called Life at Risk that combines epidemiological quantitative analysis with demographics, health agency operational research and economics to perform:",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Population Life Impacts Simulations: Measurement of the future potential impact of disease upon the population with respect to new disease cases, prevalence, premature death as well as potential years of life lost from disability and death;",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Labour Force Life Impacts Simulations: Measurement of the future potential impact of disease upon the labour force with respect to new disease cases, prevalence, premature death and potential years of life lost from disability and death;",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Economic Impacts of Disease Simulations: Measurement of the future potential impact of disease upon private sector disposable income impacts (wages, corporate profits, private health care costs) and public sector disposable income impacts (personal income tax, corporate income tax, consumption taxes, publicly funded health care costs).",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Applied field epidemiology",
            "tag": "paragraph",
            "headings": []
        },
        {
        ...
        {
            "text": "Validity: precision and bias",
            "tag": "paragraph",
            "headings": []
        },
        {
        ...
        {
            "text": "There is random error in all sampling procedures. This is called sampling error.",
            "tag": "paragraph",
            "headings": []
        },
        {
        ...
        {
            "text": "There are two basic ways to reduce random error in an epidemiological study. The first is to increase the sample size of the study. In other words, add more subjects to your study. The second is to reduce the variability in measurement in the study. This might be accomplished by using a more precise measuring device or by increasing the number of measurements.",
            "tag": "paragraph",
            "headings": []
        },
        {
            "text": "Note, that if sample size or number of measurements are increased, or a more precise measuring tool is purchased, the costs of the study are usually increased. There is usually an uneasy balance between the need for adequate precision and the practical issue of study cost.",
            "tag": "paragraph",
            "headings": []
        },
        {
