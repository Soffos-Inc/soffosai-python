...
class TableGeneratorService(SoffosAIService):
    ...
    def set_pipeline_input(self, ref_name:str, user:str, text:Union[str, Dict], table_format:Union[str, Dict]='markdown') -> None:
        self.source_config = inspect_arguments(self.set_pipeline_input, ref_name, user, text, table_format)
