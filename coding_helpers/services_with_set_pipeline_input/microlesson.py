...
class MicrolessonService(SoffosAIService):
    ...
    def set_pipeline_input(self, ref_name:str, user:str, content:Union[list, Dict]=None) -> None:
        self.source_config = inspect_arguments(self.set_pipeline_input, ref_name, user, content)
