...
class DocumentsService(SoffosAIService):
    ...
    def set_pipeline_input(self, ref_name:str, user:str, document_name:Union[str, Dict], text:Union[str, Dict]=None, tagged_elements:Union[list, Dict]=None, meta:Union[dict, Dict]=None) -> None:
        self.source_config = inspect_arguments(self.set_pipeline_input, ref_name, user, document_name, text, tagged_elements, meta)
