...
class LetsDiscussDeleteService(SoffosAIService):
    ...
    def set_pipeline_input(self, ref_name:str, user:str, session_id:Union[str, Dict], query:Union[str, Dict]) -> None:
        self.source_config = inspect_arguments(self.set_pipeline_input, ref_name, user, session_id, query)
